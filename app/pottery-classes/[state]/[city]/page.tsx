...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://www.clayfinder.com/pottery-classes/${state}/${city}` },
  }
}
  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="space-y-4">
        {listings.map((listing) => (
          <Link
            ...
            href={`/pottery-classes/${state}/${city}/${slugify(listing.name)}`}
      ...
      <div className="border-t border-stone-200 pt-6 mt-10">
        <Link href={`/pottery-classes/${state}`} className="text-amber-700 hover:underline text-sm">
